...
<div class="box_con">
	...
	<div class="con_top"><a href="<?php echo ($siteinfo["site_url"]); ?>"><?php echo ($siteinfo["site_name"]); ?></a>&nbsp;&gt;&nbsp;<a href="<?php echo ($novelinfo["classurl"]); ?>"><?php echo ($novelinfo["classname"]); ?></a>&nbsp;&gt;&nbsp;<a href="<?php echo ($novelinfo["bookurl"]); ?>"><?php echo ($novelinfo["novelname"]); ?></a>&nbsp;&gt;&nbsp;<?php echo ($coninfo["con_name"]); ?> </div>
	...
	<div class="zhangjieTXT" id="content">
	  ...
	  <div class="bottem">
		<div class="main-btn">
		<a href="<?php echo ($coninfo["prePage"]); ?>" class="prevC">&larr;上一章</a>
		<a href="<?php echo ($novelinfo["bookurl"]); ?>" id="viewList">章节目录 Enter</a>
		<a href="<?php echo ($coninfo["nextPage"]); ?>" id="prev">下一章&rarr;</a>
		</div>
	  </div>
...
<script language="javaScript" type="text/javascript">PlayHistoryObj.addPlayHistory(novelname + "|" + chaptername, window.location.href ,window.novelid);</script>